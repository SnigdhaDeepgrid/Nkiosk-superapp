...
const Homepage = () => {
  ...
  return (
    <div className="min-h-screen bg-app-gray-200">
      ...
      <section id="features" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-app-gray-900 mb-4">
              What You Get with Nkiosk
            </h2>
            <p className="text-xl text-app-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow border border-app-gray-100"
              >
                <div className="text-4xl mb-6">{feature.icon}</div>
                <h3 className="text-xl font-semibold text-app-gray-900 mb-4">
                  {feature.title}
                </h3>
      ...
      {/* Industries Section */}
      <section id="industries" className="py-20 bg-app-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-app-gray-900 mb-4">
            ...
            {[
              ...
              >
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-app-gray-900 mb-2">
                    {industry.title}
                  </h3>
                  <p className="text-app-gray-600">{industry.description}</p>
                </div>
              </div>
            ))}
          </div>
